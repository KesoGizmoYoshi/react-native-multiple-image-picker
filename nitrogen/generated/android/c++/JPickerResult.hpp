...
namespace margelo::nitro::multipleimagepicker {
  ...
  public:
    ...
    static jni::local_ref<JPickerResult::javaobject> fromCpp(const PickerResult& value) {
      using JSignature = JPickerResult(jni::alias_ref<jni::JString>, double, double, jni::alias_ref<jni::JString>, double, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JBoolean>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JString>, jni::alias_ref<JResultType>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>);
      static const auto clazz = javaClassStatic();
